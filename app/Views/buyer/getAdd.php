<div class="container mt-3">
  <div class="row justify-content-center">
    <div class="col-12 col-md-8 col-lg-6">
      <div class="form-box">
        <h2 class="mb-4">Thêm nhà máy</h2>
        <form id="buyerAddForm" action="{site_url}buyer/add" method="post" class="getDetail">
          <div class="mb-3">
          ...
          <div id="currencyList">
            ...
            <div class="form-check mb-2">
              ...
              <!-- Quỹ tiền của nhà máy chỉ cho phép bật/tắt, số dư nợ mặc định là 0 -->
            </div>
            {/currencies}
          </div>
...
$(document).ready(function(){
    $("#buyerAddForm").submit(function(e){
