...
<script>
    ...
    $(document).ready(function() 
    {
        ...
        $('#confirmCancelBtn').on('click', function() 
        {
            ...
            if (isValidId) 
            {
                ...
                $.ajax(
                {
                    ...
                    url: '{site_url}yard-goods-receipt/cancel-adjustment',
                    // Phương thức POST
                    type: 'POST',
                    // Dữ liệu gửi đi
                    data: 
        ...
        $('#confirmApproveBtn').on('click', function() 
        {
            ...
            if (isValidId) 
            {
                ...
                $.ajax(
                {
                    ...
                    url: '{site_url}yard-goods-receipt/confirm-adjustment',
                    // Phương thức POST
                    type: 'POST',
                    // Dữ liệu gửi đi
                    data: 
        ...
        // Kiểm tra và hiển thị flash message từ session nếu có
        const flashError = "{error_message}";
        
        // Biến kiểm tra có flash error không
        let hasFlashError = flashError && flashError.trim() !== '';
        ...
        const flashSuccess = "{success_message}";
        
        // Biến kiểm tra có flash success không
        let hasFlashSuccess = flashSuccess && flashSuccess.trim() !== '';
